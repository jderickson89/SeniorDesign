 ...
 */
static inline void INPUT1_set_pull_mode(const enum port_pull_mode pull_mode)
{
	PORTB_set_pin_pull_mode(0, pull_mode);
}

/**
 * \brief Set INPUT1 data direction
 *
 ...
 *                      (low power state)
 */
static inline void INPUT1_set_dir(const enum port_dir dir)
{
	PORTB_set_pin_dir(0, dir);
}

/**
 * \brief Set INPUT1 level
 *
 ...
 */
static inline void INPUT1_set_level(const bool level)
{
	PORTB_set_pin_level(0, level);
}

/**
 * \brief Toggle output level on INPUT1
 *
 * Toggle the pin level
 */
static inline void INPUT1_toggle_level()
{
	PORTB_toggle_pin_level(0);
}

/**
 * \brief Get level on INPUT1
 *
 * Reads the level on a pin
 */
static inline bool INPUT1_get_level()
{
	return PORTB_get_pin_level(0);
}

/**
 * \brief Set ENABLEA pull mode
 *
 * Configure pin to pull up, down or disable pull mode, supported pull
 * modes are defined by device used
 *
 * \param[in] pull_mode Pin pull mode
 */
static inline void ENABLEA_set_pull_mode(const enum port_pull_mode pull_mode)
{
	PORTB_set_pin_pull_mode(1, pull_mode);
}

/**
 * \brief Set ENABLEA data direction
 *
 * Select if the pin data direction is input, output or disabled.
 * If disabled state is not possible, this function throws an assert.
 *
 ...
 *                      (low power state)
 */
static inline void ENABLEA_set_dir(const enum port_dir dir)
{
	PORTB_set_pin_dir(1, dir);
}

/**
 * \brief Set ENABLEA level
 *
 * Sets output level on a pin
 *
 * \param[in] level true  = Pin level set to "high" state
 *                  false = Pin level set to "low" state
 */
static inline void ENABLEA_set_level(const bool level)
{
	PORTB_set_pin_level(1, level);
}

/**
 * \brief Toggle output level on ENABLEA
 *
 * Toggle the pin level
 */
static inline void ENABLEA_toggle_level()
{
	PORTB_toggle_pin_level(1);
}

/**
 * \brief Get level on ENABLEA
 *
 * Reads the level on a pin
 */
static inline bool ENABLEA_get_level()
{
	return PORTB_get_pin_level(1);
}

/**
 * \brief Set ENABLEB pull mode
 *
 * Configure pin to pull up, down or disable pull mode, supported pull
 * modes are defined by device used
 *
 * \param[in] pull_mode Pin pull mode
 */
static inline void ENABLEB_set_pull_mode(const enum port_pull_mode pull_mode)
{
	PORTB_set_pin_pull_mode(2, pull_mode);
}

/**
 * \brief Set ENABLEB data direction
 *
 * Select if the pin data direction is input, output or disabled.
 * If disabled state is not possible, this function throws an assert.
 *
 ...
 *                      (low power state)
 */
static inline void ENABLEB_set_dir(const enum port_dir dir)
{
	PORTB_set_pin_dir(2, dir);
}

/**
 * \brief Set ENABLEB level
 *
 * Sets output level on a pin
 *
 * \param[in] level true  = Pin level set to "high" state
 *                  false = Pin level set to "low" state
 */
static inline void ENABLEB_set_level(const bool level)
{
	PORTB_set_pin_level(2, level);
}

/**
 * \brief Toggle output level on ENABLEB
 *
 * Toggle the pin level
 */
static inline void ENABLEB_toggle_level()
{
	PORTB_toggle_pin_level(2);
}

/**
 * \brief Get level on ENABLEB
 *
 * Reads the level on a pin
 */
static inline bool ENABLEB_get_level()
{
	return PORTB_get_pin_level(2);
}

/**
 * \brief Set INPUT2 pull mode
 *
 * Configure pin to pull up, down or disable pull mode, supported pull
 * modes are defined by device used
 *
 * \param[in] pull_mode Pin pull mode
 */
static inline void INPUT2_set_pull_mode(const enum port_pull_mode pull_mode)
{
	PORTB_set_pin_pull_mode(3, pull_mode);
}

/**
 * \brief Set INPUT2 data direction
 *
 * Select if the pin data direction is input, output or disabled.
 * If disabled state is not possible, this function throws an assert.
 *
 ...
 *                      (low power state)
 */
static inline void INPUT2_set_dir(const enum port_dir dir)
{
	PORTB_set_pin_dir(3, dir);
}

/**
 * \brief Set INPUT2 level
 *
 * Sets output level on a pin
 *
 * \param[in] level true  = Pin level set to "high" state
 *                  false = Pin level set to "low" state
 */
static inline void INPUT2_set_level(const bool level)
{
	PORTB_set_pin_level(3, level);
}

/**
 * \brief Toggle output level on INPUT2
 *
 * Toggle the pin level
 */
static inline void INPUT2_toggle_level()
{
	PORTB_toggle_pin_level(3);
}

/**
 * \brief Get level on INPUT2
 *
 * Reads the level on a pin
 */
static inline bool INPUT2_get_level()
{
	return PORTB_get_pin_level(3);
}

/**
 * \brief Set INPUT3 pull mode
 *
 * Configure pin to pull up, down or disable pull mode, supported pull
 * modes are defined by device used
 *
 * \param[in] pull_mode Pin pull mode
 */
static inline void INPUT3_set_pull_mode(const enum port_pull_mode pull_mode)
{
	PORTB_set_pin_pull_mode(4, pull_mode);
}

/**
 * \brief Set INPUT3 data direction
 *
 * Select if the pin data direction is input, output or disabled.
 * If disabled state is not possible, this function throws an assert.
 *
 ...
 *                      (low power state)
 */
static inline void INPUT3_set_dir(const enum port_dir dir)
{
	PORTB_set_pin_dir(4, dir);
}

/**
 * \brief Set INPUT3 level
 *
 * Sets output level on a pin
 *
 * \param[in] level true  = Pin level set to "high" state
 *                  false = Pin level set to "low" state
 */
static inline void INPUT3_set_level(const bool level)
{
	PORTB_set_pin_level(4, level);
}

/**
 * \brief Toggle output level on INPUT3
 *
 * Toggle the pin level
 */
static inline void INPUT3_toggle_level()
{
	PORTB_toggle_pin_level(4);
}

/**
 * \brief Get level on INPUT3
 *
 * Reads the level on a pin
 */
static inline bool INPUT3_get_level()
{
	return PORTB_get_pin_level(4);
}

/**
 * \brief Set INPUT4 pull mode
 *
 * Configure pin to pull up, down or disable pull mode, supported pull
 * modes are defined by device used
 *
 * \param[in] pull_mode Pin pull mode
 */
static inline void INPUT4_set_pull_mode(const enum port_pull_mode pull_mode)
{
	PORTB_set_pin_pull_mode(5, pull_mode);
}

/**
 * \brief Set INPUT4 data direction
 *
 * Select if the pin data direction is input, output or disabled.
 * If disabled state is not possible, this function throws an assert.
 *
 ...
 *                      (low power state)
 */
static inline void INPUT4_set_dir(const enum port_dir dir)
{
	PORTB_set_pin_dir(5, dir);
}

/**
 * \brief Set INPUT4 level
 *
 * Sets output level on a pin
 *
 * \param[in] level true  = Pin level set to "high" state
 *                  false = Pin level set to "low" state
 */
static inline void INPUT4_set_level(const bool level)
{
	PORTB_set_pin_level(5, level);
}

/**
 * \brief Toggle output level on INPUT4
 *
 * Toggle the pin level
 */
static inline void INPUT4_toggle_level()
{
	PORTB_toggle_pin_level(5);
}

/**
 * \brief Get level on INPUT4
 *
 * Reads the level on a pin
 */
static inline bool INPUT4_get_level()
{
